...
# credit: https://github.com/rallip/substituteBreaker
...
'''
        Let's break the substitute code via quipqiup!
        time-param means it's processing time.
        : for CTFs, Some competitions
'''
def decodeSubstitute(cipher, time=4, spaces=True):
...
if __name__ == '__main__':
	...
	pprint(json.loads(decodeSubstitute(ciphertext)))
	# print decodeSubstitute('SIAA ZQ LKBA. VA ZOA RFPBLUAOAR!')
